...
Question: What are the most in-demand skills for the job titles researched?
    1. Join job postings to inner join table similar to query 2
    2. Identify the top 10 in-demand skills for the four job titles researched
    3. Focus on all job postings in 2025 that are remote (work from home)
    4. This query will retrieve the top 10 skills for the positions
